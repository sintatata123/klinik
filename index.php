...
<!-- Mirrored from kvthemes.com/bangodash/color-version/pages-blank-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2019 23:56:26 GMT -->
...
<head>
  ...
  <title>Klinik Diego Cihuni</title>
  <!--favicon-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="index.html" class="waves-effect">
          <i class="icon-home"></i> <span> Pendaftaran</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
      ...
      <li>
        <a href="javaScript:void();" class="waves-effect">
          <i class="icon-briefcase"></i>
          <span>Mengelola Pasien</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="sidebar-submenu">
            <li><a href="ui-typography.html"><i class="fa fa-circle-o"></i> Pasien</a></li>
        </ul>
      </li>
      <li>
        <a href="javaScript:void();" class="waves-effect">
      ...
      <li>
        <a href="javaScript:void();" class="waves-effect">
          <i class="icon-briefcase"></i>
          <span>Kelola Akun</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="sidebar-submenu">
            <li><a href="ui-typography.html"><i class="fa fa-circle-o"></i> Akun Pasien</a></li>
        </ul>
        <ul class="sidebar-submenu">
            <li><a href="ui-typography.html"><i class="fa fa-circle-o"></i> Akun Petugas</a></li>
        </ul>
        <ul class="sidebar-submenu">
            <li><a href="ui-typography.html"><i class="fa fa-circle-o"></i> Akun Dokter</a></li>
        </ul>
      </li>
      <li>
        <a href="javaScript:void();" class="waves-effect">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if (file_exists("$file")) {
                                    ...
                                    echo "<h3 class='text-center'>Halaman Tidak ditemukan</h3>";
                                }
                                ?>
                            </div>
                        </div>
